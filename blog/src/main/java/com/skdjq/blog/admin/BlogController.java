...
import com.skdjq.blog.dto.BlogQuery;
import com.skdjq.blog.dto.SearchBlog;
import com.skdjq.blog.dto.ShowBlog;
...
public class BlogController {
    ...
    public String add(Blog blog, RedirectAttributes attributes, HttpSession session) {
        ...
        //给blog中的List<Tag>赋值
        blog.setTags(tagService.getTagByString(blog.getTagId()));
        //设置用户id
